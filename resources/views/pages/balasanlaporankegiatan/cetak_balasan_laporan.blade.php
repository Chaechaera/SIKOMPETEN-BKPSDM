<x-app-layout>
        ...
        <form id="balasanForm"
            ...
            <div x-data="previewBalasan()" class="bg-white shadow-lg rounded-lg p-6 mb-10">
                ...
                <div class="mt-6 flex justify-between items-center relative">
                    ...
                    <button
                        type="button"
                        onclick="downloadBalasanLaporan()"
                        class="px-6 py-2.5 rounded-lg bg-[#FFA41B] text-white font-semibold">
                        Cetak Laporan
                    </button>
                </div>
    ...
    <script>
        async function downloadBalasanLaporan() {
            ...
            let fileName = "BalasanLaporan.pdf";
            ...
            window.location.href = "{{ route('superadmin.laporankegiatan.pending') }}";
        }
    </script>
