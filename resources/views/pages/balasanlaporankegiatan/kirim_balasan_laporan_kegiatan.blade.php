<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto p-6">
        <h1 class="text-2xl font-bold mb-6">
            Form Kirim Balasan Laporan Hasil Kegiatan Pengembangan Kompetensi ASN
        </h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('superadmin.balasanlaporankegiatan.kirim', $laporankegiatans->id) }}" enctype="multipart/form-data">
                ...
                <div class="bg-white shadow-md rounded-lg p-6 mb-8">
                    ...
                    {{-- ====================================================== --}}
                    <div class="mt-4">
                        <label class="block font-medium">Unggah File Balasan Laporan Kegiatan Final</label>
                        <p class="text-sm text-gray-500 mt-1">Format: .pdf / .doc / .docx</p>
                        <p class="text-sm text-gray-500">Contoh nama file: file_balasan_laporan_kegiatan.pdf</p>
                        <input type="file" name="filekirim_balasanlaporankegiatan" accept=".pdf,.doc,.docx" class="border p-2 w-full">
