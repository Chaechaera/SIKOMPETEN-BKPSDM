                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm" id="rekapTable">
                            ...
                            <tbody>
                                @php
                                    $data = [
                                        [1,'BKPSDM Surakarta',69,0,0,69,69,'100%'],
                                        [2,'DINKES Surakarta',56,1,0,55,55,'90%'],
                                        [3,'BKPSDM Surakarta',69,0,0,69,69,'100%'],
                                        [4,'DINKES Surakarta',56,1,0,55,55,'90%'],
                                        [5,'BKPSDM Surakarta',69,0,0,69,69,'100%'],
                                        [6,'DINKES Surakarta',56,1,0,55,55,'90%'],
                                    ];
                                @endphp
                                ...
                                <tr class="border-b hover:bg-gray-50 table-row">
                                    ...
                                    <td class="p-4 text-center">{{ $row[7] }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
