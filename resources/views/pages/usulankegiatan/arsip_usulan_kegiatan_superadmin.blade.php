<x-app-layout>
    <div class="space-y-4 px-6 py-4">
        ...
        <div class="bg-white rounded-xl shadow p-6 mb-4">
            <form method="GET" action="{{ route('superadmin.usulankegiatan.arsip') }}" class="flex flex-wrap gap-4 items-end">
                    ...
                    <tr class="border-b text-center text-sm font-normal hover:bg-abuabuCerah/30">
                        ...
                        <td class="py-3 px-4 text-center" x-data="{ openProgress: false, openDokumen: false }">
                            <div class="flex justify-center gap-4">
                                ...
                                {{-- Pulihkan --}}
                                <form action="{{ route('superadmin.usulankegiatan.restore', $u->id) }}"
                                    method="POST"
    ...
    <script>
        async function openCetakModal(id, type) {
            ...
            if (type === 'usulankegiatans') {
                url = `/superadmin/usulankegiatan/${id}/cetak`;
            }
        ...
        function closeNotification(id) {
            fetch(`/superadmin/usulankegiatan/notifikasi/${id}/close`, {
                    method: 'POST',
                    headers: {
