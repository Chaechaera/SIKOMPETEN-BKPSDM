<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto p-6">
        <h1 class="text-2xl font-bold mb-6">
            Form Kirim Pengajuan Usulan Kegiatan Pengembangan Kompetensi ASN
        </h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('admin.usulankegiatan.kirim', $usulankegiatan->id) }}" enctype="multipart/form-data">
                ...
                {{-- ===================================================== --}}
                    <div class="mt-4">
                        <label class="block font-medium">Upload File Usulan Kegiatan Final</label>
                        <p class="text-sm text-gray-500 mt-1">Format: .pdf / .doc / .docx</p>
                        <p class="text-sm text-gray-500">Contoh nama file: file_usulan_kegiatan.pdf</p>
