        ...
        <div @click.away="open = false" class="bg-white rounded-lg shadow-lg w-full max-w-5xl p-8 relative">
            ...
            <div class="mb-4">
                ...
                <div class="bg-white rounded-xl shadow p-6 mb-4">
                    <h1 class="text-2xl font-medium bg-gradient-to-r from-[#922B80] to-[#5B2C89] bg-clip-text text-transparent leading-tight">CETAK PENGAJUAN USULAN KEGIATAN PENGEMBANGAN KOMPETENSI ASN</h1>
                    <p class="text-sm text-gray-500 max-w-4xl">
                        Silahkan periksa dan pastikan data usulan kegiatan yang telah diisikan sesuai sebelum mencetak.
                    </p>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-lg p-6 mb-4">
                    <h2 class="text-lg font-bold bg-gradient-to-r from-[#922B80] to-[#5B2C89] bg-clip-text text-transparent leading-tight mb-4">
                        Ringkasan Data Usulan Kegiatan
                    </h2>
            ...
            <div class="mt-6 flex flex-col sm:flex-row justify-end gap-3">
                <a href="{{ route('admin.usulankegiatan.download', $usulan->id) }}"
                ...
                <form method="POST" action="{{ route('admin.usulankegiatan.cetak', $usulan->id) }}">
                    @csrf
                    <button type="submit"
