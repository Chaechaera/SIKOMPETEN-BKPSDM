        ...
        <div class="meta-left">
            <table class="meta-table">
                ...
                <tr>
                    ...
                    <td class="colon">:</td>
                    <td>{{ $usulankegiatans->sifat_surat ?? 'Biasa' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="colon">:</td>
                    <td><strong>{{ $usulankegiatans->identitassurats->perihal_surat ?? 'Permohonan Rekomendasi Kegiatan Pengembangan Kompetensi' }}</strong></td>
                </tr>
            </table>
        </div>
