<x-app-layout>
    ...
    {{-- Step Progress --}}
    @include('components.step-progress', ['currentStep' => 5])
    ...
    <div class="max-w-5xl mx-auto px-6 py-8 text-[#2B3674]">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500">
                    Lengkapi informasi surat dan cetak laporan kegiatan
                </p>
            </div>
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-10">
    ...
    <div class="text-sm text-gray-500">
        Step <span class="font-semibold text-[#2B3674]">5</span> dari
