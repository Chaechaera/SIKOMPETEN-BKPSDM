        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('admin.laporankegiatan.update', $usulankegiatans->id) }}" enctype="multipart/form-data">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mt-4">
                        <label class="block font-medium">Penutup Laporan</label>
                        <textarea name="penutup_laporan" class="w-full border p-2 rounded">{{ old('penutup_laporan') }}</textarea>
                        @error('penutup_laporan')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="linkundangan_laporan" value="{{ old('linkundangan_laporan') }}"
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="linkmateri_laporan" value="{{ old('linkmateri_laporan') }}"
                            class="border p-2 w-full" placeholder="https://docs.google.com/...">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="linkdaftarhadir_laporan" value="{{ old('linkdaftarhadir_laporan') }}"
                            class="border p-2 w-full" placeholder="https://docs.google.com/...">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="linkdokumentasi_laporan" value="{{ old('linkdokumentasi_laporan') }}"
                            class="border p-2 w-full" placeholder="https://docs.google.com/...">
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button type="submit" name="statuslaporan_kegiatan" value="pending"
